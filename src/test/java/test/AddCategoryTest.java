...
public class AddCategoryTest {
	...
	WebDriver driver;
	CategoryListPage listPage;
	
	Random rnd= new Random();
	String categoryName= "haris"+rnd.nextInt(100);
	...
	public void runEverything() {
		...
		listPage = PageFactory.initElements(driver, CategoryListPage.class);
	...
	public void userShouldBeAbleToAddCategory() {
		...
		List<String> actualList = listPage.getlistof();
